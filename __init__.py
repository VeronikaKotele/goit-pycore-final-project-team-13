...
from models import AddressBook, Notebook, HomeAddress, Phone, Birthday

__all__ = ['AddressBookManager', 'NotesManager', 'AddressBook', 'Notebook', 'HomeAddress', 'Phone', 'Birthday']